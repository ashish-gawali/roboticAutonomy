...
class Tracker3D():
    ...
    def __init__(self,img_topic_name= '/d400/camera/color/image_raw',depth_topic_name= '/d400/camera/depth_registered/points', see_image = False):        
    ...
    def get_xyz(self):
        ...
        t.transform.translation.x = float(xRVIZ)
        t.transform.translation.y = float(yRVIZ)
        t.transform.translation.z = float(zRVIZ)
        t.transform.rotation.x =0.0
        t.transform.rotation.y =0.0
        t.transform.rotation.z =0.0
        t.transform.rotation.w =1.0
        t.child_frame_id = '/ball_wrt_cam_frame'
        t.header.frame_id = '/d400_link'
        br = tf2_ros.TransformBroadcaster()
        br.sendTransform(t)
        # br.sendTransform((xRVIZ,yRVIZ, zRVIZ),
        # (0.0, 0.0, 0.0, 1.0),rospy.Time.now(), 'ball_wrt_cam_frame','/d400_link')
